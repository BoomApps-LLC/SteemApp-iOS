...
static NSString * const ZSSRichTextEditorToolbarBlockquote = @"com.zedsaid.toolbaritem.blockquote";
...
@class ZSSRichTextEditor, PHAsset;

@protocol ZSSRichTextEditorDelegate <NSObject>
    - (void) richTextEditor:(ZSSRichTextEditor *)richTextEditor didChangeWithText:(NSString *)text andHTML:(NSString *)html;
    - (void) richTextEditor:(ZSSRichTextEditor *)richTextEditor didAddLink:(NSString *)path localIdentifier: (NSString *) someIdentifier;
@end
...
/**
 *  The delegate of text view editor
 */
