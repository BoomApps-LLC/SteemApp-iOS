...
zss_editor.updateImage = function(url, alt, width, height) {
...
zss_editor.insertImage = function(url, alt, width, height) {
    zss_editor.restorerange();
    var html = '<img src="'+url+'" alt="'+alt+'" height="'+height+'" width="'+width+'"/>';
...
zss_editor.enabledEditingItems = function(e) {
    ...
    if (typeof(e) != "undefined") {
		...
		if (font.length != 0 && font != 'Helvetica, Arial, sans-serif') {
			items.push('fonts');	
		}
